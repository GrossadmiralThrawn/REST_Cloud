...
class UserTestData {
    ...
    {
        val obiWan                = UserData("Obi-Wan", "Kenobi", Date(1980, Calendar.SEPTEMBER, 18), "High_Ground", "A_certain point_of vi102w", "obi-wan@halfer.jediorder");
        ...
        val nameList = listOf(obiWan, anakin)
